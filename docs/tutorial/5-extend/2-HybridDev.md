...
While the chapter appears to be quite comprehensive, please consider this is a one-time action, which does not need to be repeated once configured. Before starting, please ensure that you deployed and already subscribed to the AI SaaS application within a Subscriber Subaccount. 

## Kyma

1. For starting the hybrid development, you must have installed the AI SaaS application on your Kyma Cluster using **helm install** as described in the previous tutorial steps.
...
1. For starting the hybrid development, you must have installed the AI SaaS application in your Cloud Foundry Environment using **cf deploy** as described in the previous tutorial steps.

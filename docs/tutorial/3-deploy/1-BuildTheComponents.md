...
- If you cannot use the **free** PostgreSQL service plan (e.g., SAP-managed accounts), please assign a paid service plan (+ storage service plan) to your subaccount entitlements and adjust your *mtaext* file as you can see below (smallest configuration without Multi Availability Zones)! 
  
    > **Important** - Use with caution, as this will result in costs being charged to your SAP BTP Global Account!

...
{{/*
*/}}
{{- define "ai-srv.bindingName" -}}
{{- printf "%s-%s" (include "ai-srv.fullname" .root ) .name }}
{{- end }}
...
Common labels
*/}}
{{- define "ai-srv.labels" -}}
helm.sh/revision: {{ .Release.Revision | quote }}
helm.sh/chart: {{ include "ai-srv.chart" . }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
{{ include "ai-srv.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "ai-srv.selectorLabels" -}}
app.kubernetes.io/name: {{ include "ai-srv.name" . }}
...
*/}}
{{- define "ai-srv.applicationUri" -}}
{{- include "ai-srv.fullname" . }}
{{- end }}

{{/*
Service Binding secret mounts
*/}}
{{- define "ai-srv.serviceMounts" -}}
...
*/}}
{{- define "ai-srv.serviceVolumes" -}}
{{- range $name, $params := .Values.bindings }}
{{- if ( or ( not (hasKey $params "enabled")) $params.enabled ) }}
{{- $secretName := (include "ai-srv.bindingName" (dict "root" $ "name" $name)) }}
...
*/}}
{{- define "ai-srv.imagePullSecretName" -}}
...
*/}}
{{- define "ai-srv.serviceInstanceName" -}}

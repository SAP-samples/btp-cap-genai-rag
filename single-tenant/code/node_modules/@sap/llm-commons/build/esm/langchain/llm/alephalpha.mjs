...
import { BTPAlephAlphaLuminousClient } from '../../client/alephalpha.mjs';
...
class BTPAlephAlphaLuminous extends LLM {
  constructor(fields) {
    ...
    this.BTPAlephAlphaLuminousClient = new BTPAlephAlphaLuminousClient();
  }
  _llmType() {

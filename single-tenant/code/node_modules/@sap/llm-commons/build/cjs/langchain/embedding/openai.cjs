...
class BTPOpenAIGPTEmbedding extends openai.OpenAIEmbeddings {
  constructor(fields) {
    var _a;
  ...
  async embedDocuments(documents) {
    const chunkedPrompts = utils.chunkArray(
...
exports.BTPOpenAIEmbedding = BTPOpenAIEmbedding;
exports.BTPOpenAIGPTEmbedding = BTPOpenAIGPTEmbedding;

...
import { BTPAnthropicClaudeClient } from '../../client/anthropic.mjs';
...
class BTPAnthropicClaudeChat extends ChatAnthropic {
  constructor(fields) {
    var _a;
    ...
    this.topP = 0.7;
    this.topK = 5;
    this.btpAnthropicClaudeClient = new BTPAnthropicClaudeClient();
  }
  get lc_secrets() {
    return {};
  }

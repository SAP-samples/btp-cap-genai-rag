...
class BTPAlephAlphaLuminousClient extends BaseLLMClient {
  /**
   * @param httpClient HTTP Client
   */
  constructor(httpClient) {
    super("alephalpha-luminous", httpClient);
  }
  /**
  ...
  async createTextCompletion(params, requestConfig) {
    return this.getTextCompletionResponse(params, requestConfig);
  }
}

export { BTPAlephAlphaLuminousClient };

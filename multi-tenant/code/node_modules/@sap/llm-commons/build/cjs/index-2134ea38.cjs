...
var util$1 = require('@sap-cloud-sdk/util');
...
const loadConfig = async (params) => {
  const logger = util$1.createLogger("btp-llm-commons:config-loader");
  try {
...
const _BTPLLMContext = class _BTPLLMContext {
  ...
  static async init(params) {
    if (util$1.isNullish(this.instance)) {
...
exports.BTPLLMContext = BTPLLMContext;
exports.BTPLLMError = BTPLLMError;

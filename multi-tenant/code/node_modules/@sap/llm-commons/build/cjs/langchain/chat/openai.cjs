...
class BTPOpenAIGPTChat extends openai.ChatOpenAI {
  constructor(fields) {
    var _a;
...
exports.BTPOpenAIChat = BTPOpenAIChat;
exports.BTPOpenAIGPTChat = BTPOpenAIGPTChat;

...
{{/*
*/}}
{{- define "aisaas-router.bindingName" -}}
{{- printf "%s-%s" (include "aisaas-router.fullname" .root ) .name }}
{{- end }}

{{/*
Create chart name and version as used by the chart label.
*/}}
{{- define "aisaas-router.chart" -}}
...
Common labels
*/}}
{{- define "aisaas-router.labels" -}}
helm.sh/revision: {{ .Release.Revision | quote }}
helm.sh/chart: {{ include "aisaas-router.chart" . }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
{{ include "aisaas-router.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "aisaas-router.selectorLabels" -}}
app.kubernetes.io/name: {{ include "aisaas-router.name" . }}
...
*/}}
{{- define "aisaas-router.exposeHost" -}}
...
*/}}
{{- define "aisaas-router.applicationUri" -}}
{{- include "aisaas-router.fullname" . }}
{{- end }}

{{/*
Service Binding secret mounts
*/}}
{{- define "aisaas-router.serviceMounts" -}}
...
*/}}
{{- define "aisaas-router.serviceVolumes" -}}
{{- range $name, $params := .Values.bindings }}
{{- if ( or ( not (hasKey $params "enabled")) $params.enabled ) }}
{{- $secretName := (include "aisaas-router.bindingName" (dict "root" $ "name" $name)) }}
...
*/}}
{{- define "aisaas-router.imagePullSecretName" -}}
...
*/}}
{{- define "aisaas-router.imageName" -}}
...
*/}}
{{- define "aisaas-router.serviceInstanceName" -}}
...
{{- define "aisaas-router.processEnv" -}}
{{- $result := dict }}
{{- $variables := list }}
{{- range $k, $v := . }}
  {{- $variable := dict }}

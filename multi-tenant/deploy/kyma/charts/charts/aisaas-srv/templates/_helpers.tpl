...
{{/*
*/}}
{{- define "aisaas-srv.bindingName" -}}
{{- printf "%s-%s" (include "aisaas-srv.fullname" .root ) .name }}
{{- end }}

{{/*
Create chart name and version as used by the chart label.
*/}}
{{- define "aisaas-srv.chart" -}}
...
Common labels
*/}}
{{- define "aisaas-srv.labels" -}}
helm.sh/revision: {{ .Release.Revision | quote }}
helm.sh/chart: {{ include "aisaas-srv.chart" . }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
{{ include "aisaas-srv.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "aisaas-srv.selectorLabels" -}}
app.kubernetes.io/name: {{ include "aisaas-srv.name" . }}
...
*/}}
{{- define "aisaas-srv.applicationUri" -}}
{{- include "aisaas-srv.fullname" . }}
{{- end }}

{{/*
Service Binding secret mounts
*/}}
{{- define "aisaas-srv.serviceMounts" -}}
...
*/}}
{{- define "aisaas-srv.serviceVolumes" -}}
{{- range $name, $params := .Values.bindings }}
{{- if ( or ( not (hasKey $params "enabled")) $params.enabled ) }}
{{- $secretName := (include "aisaas-srv.bindingName" (dict "root" $ "name" $name)) }}
...
*/}}
{{- define "aisaas-srv.imagePullSecretName" -}}
...
*/}}
{{- define "aisaas-srv.serviceInstanceName" -}}

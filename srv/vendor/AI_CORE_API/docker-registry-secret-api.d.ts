...
export declare const DockerRegistrySecretApi: {
  ...
  ) => OpenApiRequestBuilder<DockerRegistrySecretStatus>;
  /**
  ...
  kubesubmitV4DockerRegistrySecretsPatch: (
    dockerRegistryName: string,
    body: any
  ) => OpenApiRequestBuilder<DockerRegistrySecretModificationResponse>;
  /**
  ...
  kubesubmitV4DockerRegistrySecretsDelete: (
    dockerRegistryName: string
  ) => OpenApiRequestBuilder<DockerRegistrySecretDeletionResponse>;
  /**
  ...
  kubesubmitV4DockerRegistrySecretsQuery: (queryParameters?: {
    $top?: number;
    $skip?: number;
  }) => OpenApiRequestBuilder<DockerRegistrySecretStatusResponse>;
  /**

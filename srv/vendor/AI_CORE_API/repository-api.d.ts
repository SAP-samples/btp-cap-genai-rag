...
export declare const RepositoryApi: {
   ...
   */
  kubesubmitV4RepositoriesGetAll: () => OpenApiRequestBuilder<ArgoCDRepositoryDataResponse>;
  /**
  ...
  ) => OpenApiRequestBuilder<ArgoCDRepositoryCreationResponse>;
  /**
  ...
  ) => OpenApiRequestBuilder<ArgoCDRepositoryDetails>;
  /**
  ...
  ) => OpenApiRequestBuilder<ArgoCDRepositoryModificationResponse>;
  /**
  ...
  kubesubmitV4RepositoriesDelete: (
    repositoryName: string
  ) => OpenApiRequestBuilder<ArgoCDRepositoryDeletionResponse>;
};

...
exports.FileApi = {
     ...
     */
    fileDownload: (path) => new openapi_1.OpenApiRequestBuilder('get', '/lm/dataset/files/{path}', {
        pathParameters: { path }
    }),
    /**
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    fileUpload: (path, body, queryParameters) => new openapi_1.OpenApiRequestBuilder('put', '/lm/dataset/files/{path}', {
        pathParameters: { path },
        body,
        queryParameters
    }),
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    fileDelete: (path) => new openapi_1.OpenApiRequestBuilder('delete', '/lm/dataset/files/{path}', {
        pathParameters: { path }
    })
};
